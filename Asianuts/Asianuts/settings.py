"""
 Django settings for Asianuts project.
...
SECRET_KEY = 'django-insecure-s8gr9&avx31_j7*u+mqgcm07#2=(pf8is)2^vb*wyuoc-53@py'
...
WSGI_APPLICATION = 'Asianuts.wsgi.application'
